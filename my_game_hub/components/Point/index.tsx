...
export class Point implements IPoint {
  ...
  constructor(POINT_GAP: number, i: number, canvasWidth: number, canvasHeight: number) {
    this.pointCenterX = POINT_GAP * i;
    this.radian = i * 0.38;
    this.CENTER_LINE = canvasHeight / 3;
    this.VELOCITY = 0.005;
    this.AMPLITUDE = canvasHeight / 14;
    this.POINT_RADIUS = canvasWidth / 370 > 5.8 ? 5.8 : canvasWidth / 370 > 2.5 ? 2.5 : canvasWidth / 370;
